...
kotlin {
    ...
    swiftExport {
        moduleName = "Url"
        flattenPackage = "io.github.kotlinmania.url"
    }

    android {
        namespace = "io.github.kotlinmania.url"
        compileSdk = 34
        minSdk = 24
...
mavenPublishing {
    ...
    coordinates(group.toString(), "url-kotlin", version.toString())

    pom {
        name.set("url-kotlin")
        description.set("Kotlin Multiplatform port of servo/rust-url - URL library for Rust, based on the WHATWG URL Standard")
        inceptionYear.set("2026")
        url.set("https://github.com/KotlinMania/url-kotlin")
        ...
        scm {
            url.set("https://github.com/KotlinMania/url-kotlin")
            connection.set("scm:git:git://github.com/KotlinMania/url-kotlin.git")
            developerConnection.set("scm:git:ssh://github.com/KotlinMania/url-kotlin.git")
        }
    }
}
...
val fullTargetBuildTasks = listOf(
    ...
    "assembleUrlXCFramework",
    "assembleUrlDebugXCFramework",
    "assembleUrlReleaseXCFramework",
    "assembleDebugIosFatFrameworkForUrlXCFramework",
    "assembleReleaseIosFatFrameworkForUrlXCFramework",
    "assembleDebugIosSimulatorFatFrameworkForUrlXCFramework",
    "assembleReleaseIosSimulatorFatFrameworkForUrlXCFramework",
    "assembleDebugMacosFatFrameworkForUrlXCFramework",
    "assembleReleaseMacosFatFrameworkForUrlXCFramework",
    "assembleDebugTvosFatFrameworkForUrlXCFramework",
    "assembleReleaseTvosFatFrameworkForUrlXCFramework",
    "assembleDebugTvosSimulatorFatFrameworkForUrlXCFramework",
    "assembleReleaseTvosSimulatorFatFrameworkForUrlXCFramework",
    "assembleDebugWatchosFatFrameworkForUrlXCFramework",
    "assembleReleaseWatchosFatFrameworkForUrlXCFramework",
    "assembleDebugWatchosSimulatorFatFrameworkForUrlXCFramework",
    "assembleReleaseWatchosSimulatorFatFrameworkForUrlXCFramework",
