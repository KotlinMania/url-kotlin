...
This file is the quick-reference operating contract for url-kotlin. The longer
...
url-kotlin is a Kotlin Multiplatform port of the upstream Rust crate or module
[`url`](https://crates.io/crates/url). Upstream Rust is the behavioral oracle while the
